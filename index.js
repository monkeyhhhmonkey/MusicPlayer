console.log("bug提交给 LiuYX20091@outlook.com");
// 音乐播放器
class MusicPlayer {
    constructor(
        data = {
            ...
            songObjArr: [
                {
                    title: "悬溺",  // 歌曲名
                    author: "葛东琪",   // 歌手
                    imgSrc: "./public/images/xn.png", // 图片路径
                    url: "./public/audios/xn.mp3", // 音频路径
                },
                {
                    title: "雨一直下",
                    author: "张宇",
                    imgSrc: "./public/images/yyzx.png",
                    url: "./public/audios/yuYiZhiXia.mp3",
                },
                {
                    title: "成都",
                    author: "赵雷",
                    imgSrc: "./public/images/cd.png",
                    url: "./public/audios/chengDu.mp3",
                },
                {
                    title: "爱情错觉",
                    author: "半吨兄弟",
                    imgSrc: "./public/images/aqcj.png",
                    url: "./public/audios/aiQingCuoJue.mp3",
                },
            ],
            currentIndex: 0,
        }
